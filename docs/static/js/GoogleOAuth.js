function eIDGoogleLogin(id_token, res) {
...
function GoogleLogin() {
  ...
  auth2.signIn().then(function (GoogleUser) {
	    ...
	    'personFields': 'names,emailAddresses',
				...
				var resultJSON = {};
				resultJSON = eIDGoogleLogin(id_token, res);

				try {
					// Set LocalStorage
					setLocalStorage("jwt", resultJSON.token);
					setLocalStorage("username", resultJSON.username);
				} catch (e) {alert("登入失敗，請洽系統管理員！"); return;}
